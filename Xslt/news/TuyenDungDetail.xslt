						...
						<div class="wrapper-btn d-flex align-center">
							<div class="apply text-uppercase">
								<a href="javascript: ;">
									...
									<xsl:value-of disable-output-escaping="yes" select="ApplyTxt"></xsl:value-of>
								</a>
							</div>
							<span>
								<xsl:value-of disable-output-escaping="yes" select="OrTxt"></xsl:value-of>
							</span>
							<div class="view text-uppercase">
								<em class="material-icons">download</em>
								<a href="">
									<xsl:value-of disable-output-escaping="yes" select="DownloadFormTxt"></xsl:value-of>
								</a>
							</div>
						</div>
					</div>
					<div class="col-lg-3">
						...
						<div class="recuirement-other">
							<div class="recuirement-header">
								<div class="title f-24 fw-600 color-main">
									<xsl:value-of disable-output-escaping="yes" select="OtherPositionTxt">
									</xsl:value-of>
								</div>
							</div>
