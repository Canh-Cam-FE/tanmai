...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt" exclude-result-prefixes="msxsl">
    ...
    <xsl:template match="Zone">
        <xsl:if test="position() = 1">
            <section class="section field-list" id="sec-1">
                <div class="container">
        ...
        <xsl:if test="position() = 2">
            <section class="section field-forestry" id="sec-2">
        ...
        <xsl:if test="position() = 3">
            <section class="section field-forestry" id="sec-3">
                <div class="container">
                    <div class="row">
        ...
        <xsl:if test="position() = 4">
            <section class="section field-agriculture" id="sec-4">
        ...
        <xsl:if test="position() = 5">
            <section class="section field-energy" id="sec-5">
                <div class="container">
                    <div class="row">
        ...
        <xsl:if test="position() = 6">
            <section class="section field-real" id="sec-6">
                <xsl:attribute name="setBackground">
                    <xsl:value-of disable-output-escaping="yes" select="SecondImageUrl"></xsl:value-of>
                </xsl:attribute>
                <div class="container">
            ...
            <div class="content fw-600 text-uppercase text-center">
                <a>
                    <xsl:attribute name="href">
                        ...
                        <xsl:value-of disable-output-escaping="yes" select="position()+1"></xsl:value-of>
                    </xsl:attribute>
