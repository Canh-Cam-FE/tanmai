...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt" exclude-result-prefixes="msxsl">
            ...
            <section class="section about">
                ...
                <div class="container">
                    ...
                    <div class="wrapper-list d-flex align-center">
                        <xsl:apply-templates select="News[position() &gt;0 and position() &lt;4]" mode="ListTop"></xsl:apply-templates>
                    </div>
        ...
        <xsl:if test="position() = 8">
            <section class="section prize">
                ...
                <div class="container">
                    ...
                    <div class="wrapper-content">
                        <div class="row">
                            <xsl:apply-templates select="News" mode="ThanhTich"></xsl:apply-templates>
                        </div>
                    </div>
                </div>
            </section>
    ...
    <xsl:template match="News" mode="ThanhTich">
        <div class="col-lg-6">
            <div class="content">
                <xsl:value-of disable-output-escaping="yes" select="BriefContent"></xsl:value-of>
            </div>
