		...
		<asp:UpdatePanel ID="upContact" runat="server">
			<ContentTemplate>
				<asp:Panel ID="pnlNewComment" DefaultButton="btnPostComment" runat="server">
					<h4>
						<asp:Literal ID="litNote" Text="<%$Resources:NewsResources, JobNoteLabel %>"
							EnableViewState="false" runat="server" />
						(<span class="required">
							<asp:Literal ID="litNoteStarRequired"
								Text="<%$Resources:NewsResources, JobRequiredStarLabel %>" EnableViewState="false"
								runat="server" /></span> :
						<asp:Literal ID="litNoteRequired" Text="<%$Resources:NewsResources, JobRequiredLabel %>"
							EnableViewState="false" runat="server" />)
					</h4>
					<div class="row">
						<div class="col-left col-lg-6 col-md-6">
						...
						<div class="col-right col-lg-6 col-md-6">
							<div class="form-group">
								<label class="label">
